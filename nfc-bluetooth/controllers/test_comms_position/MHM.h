...
extern char message[37+1], tmp_s[37+1], tmp_ss[3+1];
...
void construct_inform_location_message(char* sender, char* receiver, char* team_ID_s, char* TTL,  float x_ref, float y_ref, int angle, int team_idx);
#endif 