...
void leader_store_external_connection(int hop_idx, char* ext_ID_s, char* ext_leader_ID_s, int ext_team_size) {
  strcpy(ext_connections[hop_idx-1].ext_ID_s, ext_ID_s);
  strcpy(ext_connections[hop_idx-1].ext_leader_ID_s, ext_leader_ID_s);
  ext_connections[hop_idx-1].size += ext_team_size;
}
